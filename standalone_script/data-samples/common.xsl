...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:kpt="urn://x-artefacts-rosreestr-ru/outgoing/kpt/10.0.1" xmlns:adr="urn://x-artefacts-rosreestr-ru/commons/complex-types/address-output/4.0.1" xmlns:cert="urn://x-artefacts-rosreestr-ru/commons/complex-types/certification-doc/1.0" xmlns:doc="urn://x-artefacts-rosreestr-ru/commons/complex-types/document-output/4.0.1" xmlns:param="urn://x-artefacts-rosreestr-ru/commons/complex-types/parameters-oks/2.0.1" xmlns:spa="urn://x-artefacts-rosreestr-ru/commons/complex-types/entity-spatial/5.0.1" xmlns:tns="urn://x-artefacts-smev-gov-ru/supplementary/commons/1.0.1">
	...
	<!--Версия: 41-->
	<!--25.10.2016 Изменен алгоритм графики-->
	<xsl:strip-space elements="*"/>
	<xsl:output method="html" indent="yes" omit-xml-declaration="yes" media-type="text/javascript" encoding="UTF-8"/>

	<!--Корневой УРЛ-->
	<xsl:param name="url" select="'https://portal.rosreestr.ru/'"/>
	<!--xsl:param name="url" select="''"/-->

	<!--Путь к справочникам отсчитывается относительно основного шаблона-->
	<xsl:param name="urlPrefixDict" select="concat($url, 'xsl/GKN/KPT/10/')"/>
	<!--xsl:param name="urlPrefixDict" select="concat($url, '')"/-->
	...
	<xsl:variable name="spatials" select="($blocks/kpt:SpatialData/kpt:EntitySpatial/spa:SpatialElement|$blocks/kpt:Bounds/descendant::spa:SpatialElement|$blocks/kpt:Zones/descendant::spa:SpatialElement)/spa:SpelementUnit"/>
	...
	<xsl:variable name="decisions" select="($blocks/kpt:SpatialData/kpt:Documents|$blocks/kpt:Bounds/descendant::kpt:Documents|$blocks/kpt:Zones/descendant::kpt:Documents)/kpt:Document|$blocks/kpt:SpatialData"/>
	...
	<xsl:variable name="object_records" select="count($objects/kpt:ObjectRealty)"/>
	<!--Количество решений-->
	...
	<!--Количество листов КПТ1.1-->
	<xsl:variable name="kpt11listcount">
		<xsl:choose>
			<xsl:when test="$parcel_records &gt; $max_page_records">
				<xsl:value-of select="ceiling($parcel_records div $max_page_records)"/>
			</xsl:when>
			<xsl:when test="not($parcel_records)">
	...
	<!--Количество листов КПТ1.2-->
	<xsl:variable name="kpt12listcount">
		<xsl:choose>
			<xsl:when test="$object_records &gt; ($max_page_records+1)">
				<xsl:value-of select="ceiling($object_records div ($max_page_records+1))"/>
			</xsl:when>
	...
	<!--Количество листов КПТ2.1-->
	<xsl:variable name="kpt21listcount">
	...
	<!--Количество листов КПТ2.2-->
	<xsl:variable name="kpt22listcount">
	...
	<!--Количество листов КПТ2.3-->
	<xsl:variable name="kpt23listcount">
	...
	<!--Количество листов КПТ2.4-->
	<xsl:variable name="kpt24listcount">
	...
	<!--Количество листов КПТ3.1-->
	<xsl:variable name="kpt31listcount">
		<xsl:choose>
	...
	<!--Количество листов КПТ3.2-->
	<xsl:variable name="kpt32listcount">
		<xsl:choose>
	...
	<!--Количество листов КПТ4.1-->
	<xsl:variable name="kpt41listcount">
		<xsl:choose>
	...
	<!--Количество листов КПТ4.2-->
	<xsl:variable name="kpt42listcount">
		<xsl:choose>
	...
	<xsl:variable name="kptAllcount">
		<xsl:value-of select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+$kpt24listcount+$kpt31listcount+$kpt32listcount+$kpt41listcount+$kpt42listcount+$kpt5listcount"/>
	</xsl:variable>
...
function load(id, Coords, minX, minY, maxX, maxY) {
    ...
    canvas.onmousewheel = function (event) {
        ...
        var zoom = Math.pow(0.1 + Math.abs(wheel) / 2, wheel > 0 ? 0.1 : -0.1);
		scale *= zoom;
    ...
    $(canvas).mousedown(function mouseMove(event)
    {
		...
		$(document).bind('mousemove.cropper', function (event) {
			var x = event.clientX, y = event.clientY, newX = (oldX - x) * -2, newY = (oldY - y) * -2;
...
if (CP && CP.lineTo){
		...
		while (distRemaining>=0.1){
			...
			draw = !draw;
					...
					<script type="text/javascript">
						...
						<xsl:if test="descendant::kpt:SpatialData/kpt:EntitySpatial|descendant::kpt:Parcel/descendant::kpt:EntitySpatial|descendant::kpt:ObjectsRealty/descendant::kpt:EntitySpatial">
							<xsl:text>var minX1 = </xsl:text><xsl:value-of select="$minX1"/><xsl:text>;</xsl:text>
							<xsl:text>var minY1 = </xsl:text><xsl:value-of select="$minY1"/><xsl:text>;</xsl:text>
							<xsl:text>var maxX1 = </xsl:text><xsl:value-of select="$maxX1"/><xsl:text>;</xsl:text>
							<xsl:text>var maxY1 = </xsl:text><xsl:value-of select="$maxY1"/><xsl:text>;</xsl:text>
						</xsl:if>
						<xsl:if test="not(descendant::kpt:SpatialData/kpt:EntitySpatial|descendant::kpt:Parcel/descendant::kpt:EntitySpatial|descendant::kpt:ObjectsRealty/descendant::kpt:EntitySpatial)">
						...
						<xsl:if test="descendant::kpt:Bound/descendant::kpt:EntitySpatial">
							<xsl:text>var minX2 = </xsl:text><xsl:value-of select="$minX2"/><xsl:text>;</xsl:text>
							<xsl:text>var minY2 = </xsl:text><xsl:value-of select="$minY2"/><xsl:text>;</xsl:text>
							<xsl:text>var maxX2 = </xsl:text><xsl:value-of select="$maxX2"/><xsl:text>;</xsl:text>
							<xsl:text>var maxY2 = </xsl:text><xsl:value-of select="$maxY2"/><xsl:text>;</xsl:text>
						</xsl:if>
						<xsl:if test="not(descendant::kpt:Bound/descendant::kpt:EntitySpatial)">
						...
						<xsl:if test="descendant::kpt:Zone[kpt:SpecialZone]/descendant::kpt:EntitySpatial">
							<xsl:text>var minX3 = </xsl:text><xsl:value-of select="$minX3"/><xsl:text>;</xsl:text>
							<xsl:text>var minY3 = </xsl:text><xsl:value-of select="$minY3"/><xsl:text>;</xsl:text>
							<xsl:text>var maxX3 = </xsl:text><xsl:value-of select="$maxX3"/><xsl:text>;</xsl:text>
							<xsl:text>var maxY3 = </xsl:text><xsl:value-of select="$maxY3"/><xsl:text>;</xsl:text>
						</xsl:if>
						<xsl:if test="not(descendant::kpt:Zone[kpt:SpecialZone]/descendant::kpt:EntitySpatial)">
						...
						<xsl:if test="descendant::kpt:Zone[kpt:TerritorialZone]/descendant::kpt:EntitySpatial">
							<xsl:text>var minX4 = </xsl:text><xsl:value-of select="$minX4"/><xsl:text>;</xsl:text>
							<xsl:text>var minY4 = </xsl:text><xsl:value-of select="$minY4"/><xsl:text>;</xsl:text>
							<xsl:text>var maxX4 = </xsl:text><xsl:value-of select="$maxX4"/><xsl:text>;</xsl:text>
							<xsl:text>var maxY4 = </xsl:text><xsl:value-of select="$maxY4"/><xsl:text>;</xsl:text>
						</xsl:if>
						<xsl:if test="not(descendant::kpt:Zone[kpt:TerritorialZone]/descendant::kpt:EntitySpatial)">
			...
			<xsl:element name="body">
				<xsl:attribute name="onload">
					<xsl:if test="descendant::kpt:SpatialData/kpt:EntitySpatial|descendant::kpt:Parcel/descendant::kpt:EntitySpatial|descendant::kpt:ObjectsRealty/descendant::kpt:EntitySpatial">
						<xsl:text>load('canvas1', Coords1, minX1, minY1, maxX1, maxY1);</xsl:text>
					</xsl:if>
					<xsl:if test="descendant::kpt:Bound/descendant::kpt:EntitySpatial">
						<xsl:text>load('canvas2', Coords2, minX2, minY2, maxX2, maxY2);</xsl:text>
					</xsl:if>
					<xsl:if test="descendant::kpt:Zone[kpt:SpecialZone]/descendant::kpt:EntitySpatial">
						<xsl:text>load('canvas3', Coords3, minX3, minY3, maxX3, maxY3);</xsl:text>
					</xsl:if>
					<xsl:if test="descendant::kpt:Zone[kpt:TerritorialZone]/descendant::kpt:EntitySpatial">
						<xsl:text>load('canvas4', Coords4, minX4, minY4, maxX4, maxY4);</xsl:text>
					</xsl:if>
				</xsl:attribute>
				<xsl:apply-templates/>
			</xsl:element>
	...
	<xsl:template match="kpt:Category" mode="describe">
		<xsl:variable name="categories" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dCategories_v01.xsd'))"/>
	...
	<xsl:template match="kpt:Utilization">
		<xsl:if test="string(@LandUse)">
			<xsl:variable name="resolvedLand" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dAllowedUse_v02.xsd'))"/>
		...
		<xsl:if test="not(string(@ByDoc)) and not(string(@LandUse))">
			<xsl:variable name="resolved" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dUtilizations_v01.xsd'))"/>
	...
	<xsl:template match="kpt:Address">
		<xsl:if test="not(string(adr:Note))">
			...
			<xsl:if test="string(adr:Region)">
				<xsl:variable name="region" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dRegionsRF_v01.xsd'))"/>
	...
	<xsl:template match="kpt:Building|kpt:Construction|kpt:Uncompleted">
		...
		<xsl:if test="position() &gt; $start_number and position() &lt; ($start_number + ($max_page_records+1))+1">
			<tr>
				...
				<td class="td_center">
					<xsl:variable name="realty" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dRealty_v03.xsd'))"/>
				...
				<td class="td_center">
					<xsl:if test="not(kpt:ConditionalPartLinear)">
						...
						<xsl:if test="kpt:KeyParameters">
							<xsl:variable name="params" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dTypeParameter_v01.xsd'))"/>
				...
				<td class="td_center">
					<xsl:if test="not(kpt:ConditionalPartLinear)">
						<xsl:if test="kpt:AssignationBuilding">
							<xsl:variable name="assign" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dAssBuilding_v01.xsd'))"/>
			...
			<tr>
				...
				<td class="td_center">
					...
					<xsl:if test="not(string(doc:Name))">
						<xsl:variable name="ddoc" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dAllDocumentsOut_v03.xsd'))"/>
				...
				<td class="td_center">
					<xsl:if test="$parent/kpt:TerritorialZone">
						<xsl:variable name="permituse" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dPermitUse_v01.xsd'))"/>
						<xsl:variable name="utilization" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dUtilizations_v01.xsd'))"/>
						<xsl:variable name="landuse" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dAllowedUse_v02.xsd'))"/>
	...
	<xsl:template match="kpt:SpatialData">
		<xsl:param name="parent" select=".."/>
		<xsl:param name="start_number"/>
		<xsl:if test="not(kpt:Documents)">
			<xsl:if test="position() &gt; $start_number and position() &lt; ($start_number + ($max_page_records+1))+1">
				<tr>
					<!--Номер объекта землеустройства-->
					<td class="td_center">
						<xsl:value-of select="$parent/@CadastralNumber"/>
						<xsl:if test="not(string($parent/@CadastralNumber))">
							<xsl:call-template name="procherk"/>
						</xsl:if>
					</td>
					<!--Вид и наименование объекта землеустройства-->
			...
			<tr>
				...
				<td class="td_center">
					<xsl:if test="string(spa:Ordinate/@GeopointOpred)">
						<xsl:variable name="categories" select="document(concat($urlPrefixDict, 'schema/KPT_v10/SchemaCommon/dGeopointOpred_v01.xsd'))"/>
						<xsl:variable name="kod" select="spa:Ordinate/@GeopointOpred"/>
						<xsl:value-of select="$categories//xs:enumeration[@value=$kod]/xs:annotation/xs:documentation"/>
					</xsl:if>
					<xsl:if test="not(string(spa:Ordinate/@GeopointOpred))">
						<xsl:call-template name="procherk"/>
					</xsl:if>
				</td>
				<td class="td_center">
	...
	<xsl:template name="Page1_1">
				...
				<td>
					...
					<nobr>
						<div class="small_text">
							<xsl:text>(полное наименование органа кадастрового учета)</xsl:text>
						</div>
					</nobr>
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="1.1"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ.1.1-->
					<table class="tbl_section_content">
						<xsl:attribute name="class">tbl_section_content</xsl:attribute>
						<tr>
							<td width="5%"><b>1</b></td>
							<td colspan="6" style="margin: 0; padding: 0">
								<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
									<tr>
										<td style="width: 73%; border-top: 0; border-bottom: 0; border-left: 0">
											<b>
						...
						<xsl:if test="$current_number &lt; $max_page_records">
							...
							<tr>
								...
								<td colspan="8">
									<b>
										<nobr>Общие сведения о земельных участках в кадастровом квартале:</nobr>
									</b>
								</td>
							</tr>
						</xsl:if>
						<tr>
							<td class="td_center" width="5%"><b>Номер п/п</b></td>
							<td class="td_center" width="15%"><b>Кадастровый номер земельного участка</b></td>
							<td class="td_center" width="20%"><b>Адрес (описание местоположения)</b></td>
							<td class="td_center" width="15%"><b>Категория земель</b></td>
							<td class="td_center" width="15%"><b>Разрешенное использование</b></td>
							<td class="td_center" width="10%"><b>Площадь, кв.м</b></td>
							<td class="td_center" width="10%"><b>Кадастровая стоимость (руб)</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>1</b></td>
							<td class="td_center"><b>2</b></td>
							<td class="td_center"><b>3</b></td>
							<td class="td_center"><b>4</b></td>
							<td class="td_center"><b>5</b></td>
							<td class="td_center"><b>6</b></td>
							<td class="td_center"><b>7</b></td>
						</tr>
						<!--Выводим участки-->
		...
		<xsl:if test="($current_number + $max_page_records) &lt; $parcel_records">
			<xsl:call-template name="Page1_1">
	...
	<xsl:template name="Page1_2">
		...
		<table class="tbl_page">
			<tr>
				<td>
					...
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="1.2"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ.1.2-->
					<table class="tbl_section_content">
						<xsl:attribute name="class">tbl_section_content</xsl:attribute>
						<tr>
							<td width="5%"><b>1</b></td>
						...
						<xsl:if test="$current_number &lt; ($max_page_records+1)">
							<tr>
								<td width="5%"><b>2</b></td>
								<td colspan="8">
									<b>
										<nobr>Общие сведения о зданиях, сооружениях, объектах незавершенного строительства в кадастровом квартале:</nobr>
									</b>
								</td>
							</tr>
						</xsl:if>
						<tr>
							<td class="td_center" width="5%"><b>Номер п/п</b></td>
							<td class="td_center" width="10%"><b>Вид объекта недвижимости</b></td>
							<td class="td_center" width="15%"><b>Кадастровый номер объекта недвижимости</b></td>
							<td class="td_center" width="20%"><b>Адрес (описание местоположения)</b></td>
							<td class="td_center" width="15%"><b>Площадь или основная характеристика</b></td>
							<td class="td_center" width="15%"><b>Назначение (проектируемое назначение)</b></td>
							<td class="td_center" width="10%"><b>Кадастровая стоимость (руб)</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>1</b></td>
		...
		<!--Если есть еще невыведенные объекты, начинаем следующую страницу-->
		<xsl:if test="($current_number + ($max_page_records+1)) &lt; $object_records">
			<xsl:call-template name="Page1_2">
	...
	<xsl:template name="Page2_1">
		...
		<table class="tbl_page">
			<tr>
				<td>
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="2.1"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ2.1-->
					<table class="tbl_section_content" style="width: 100%">
						<tr>
							<td style="width: 75%">
								<b>
									<nobr>Номер кадастрового квартала: </nobr>
					...
					<table class="tbl_section_content" style="border-top: 0px;">
						<tr>
							<td rowspan="2" width="5%" style="vertical-align: top; border-top: 0px;"><b>1</b></td>
							<td colspan="2" style="border-top: 0px;"><b>План (чертеж, схема) земельных участков, зданий, сооружений, объектов незавершенного строительства, расположенных в кадастровом квартале:</b></td>
						</tr>
						<tr>
							<td>
								<div align="center">
					...
					<table class="tbl_section_content" style="width: 100%; border-top: 0px;">
						<tr>
							<td width="13" style="border-top: 0px;"><b>2</b></td>
							<td width="20%" style="border-top: 0px;"><b>Масштаб:</b></td>
	...
	<xsl:template name="Page2_2">
		...
		<table class="tbl_page">
			<tr>
				<td>
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="2.2"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ2.2-->
					<table class="tbl_section_content" style="width: 100%">
						<tr>
							<td style="width: 75%">
								<b>
					...
					<table class="tbl_section_content" style="border-top: 0px;">
						<tr>
							<td rowspan="2" width="5%" style="vertical-align: top; border-top: 0px;"><b>1</b></td>
							<td colspan="2" style="border-top: 0px;"><b>План (чертеж, схема) границ между субъектами Российской Федерацией, границ населенных пунктов, границ муниципальных образований, расположенных в кадастровом квартале:</b></td>
						</tr>
						<tr>
							<td>
								<div align="center">
	...
	<xsl:template name="Page2_3">
		...
		<table class="tbl_page">
			<tr>
				<td>
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="2.3"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ2.3-->
					<table class="tbl_section_content" style="width: 100%">
						<tr>
							<td style="width: 75%">
								<b>
					...
					<table class="tbl_section_content" style="border-top: 0px;">
						<tr>
							<td rowspan="2" width="5%" style="vertical-align: top; border-top: 0px;"><b>1</b></td>
							<td colspan="2" style="border-top: 0px;"><b>План (чертеж, схема) зон с особыми условиями использования территорий, расположенных в кадастровом квартале:</b></td>
						</tr>
						<tr>
							<td>
								<div align="center">
	...
	<xsl:template name="Page2_4">
		...
		<table class="tbl_page">
			<tr>
				<td>
					<xsl:call-template name="section_title">
						<xsl:with-param name="pageNumber" select="2.4"/>
					</xsl:call-template>
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ2.4-->
					<table class="tbl_section_content" style="width: 100%">
						<tr>
							<td style="width: 75%">
								<b>
					...
					<table class="tbl_section_content" style="border-top: 0px;">
						<tr>
							<td rowspan="2" width="5%" style="vertical-align: top; border-top: 0px;"><b>1</b></td>
							<td colspan="2" style="border-top: 0px;"><b>План (чертеж, схема) территориальных зон, расположенных в кадастровом квартале:</b></td>
						</tr>
						<tr>
							<td>
								<div align="center">
	...
	<xsl:template name="Page3_1">
		...
		<table class="tbl_page">
			<tr>
				<td>
					...
					<xsl:call-template name="section_date"/>
					<br/>
					<!--Основная таблица КПТ3.1-->
					<table class="tbl_section_content" style="width: 100%; border-bottom: 0">
						<tr>
							<td style="width: 75%; border-bottom: 0">
								<b>
									<nobr>Номер кадастрового квартала: </nobr>
									<nobr>
										<xsl:value-of select="$CadastralNumber"/>
					...
					<table class="tbl_section_content">
						<xsl:if test="$current_number &lt; $max_page_records*4">
							<tr>
								<td colspan="6">
									<b>Описание местоположения границ земельных участков</b>
								</td>
							</tr>
						</xsl:if>
						<tr>
							<td class="td_center" rowspan="2" width="20%"><b>Кадастровый номер земельного участка</b></td>
							<td class="td_center" rowspan="2" width="10%"><b>Номера точек</b></td>
							<td class="td_center" colspan="2" width="20%"><b>Координаты</b></td>
							<td class="td_center" rowspan="2" width="20%"><b>Описание закрепления на местности</b></td>
							<td class="td_center" rowspan="2" width="30%"><b>Особые отметки (точность определения)</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>X</b></td>
							<td class="td_center"><b>Y</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>1</b></td>
							<td class="td_center"><b>2</b></td>
		...
		<xsl:if test="($current_number + ($max_page_records*4)) &lt; $spatialParcels_records">
			...
			<xsl:call-template name="Page3_1">
	...
	<xsl:template name="Page3_2">
				...
				<td>
					...
					<table class="tbl_section_content">
						<xsl:if test="$current_number &lt; $max_page_records*4">
							<tr>
								<td colspan="6">
									<b>Описание местоположения границ зданий, сооружений, объектов незавершенного строительства на земельном участке</b>
								</td>
							</tr>
						</xsl:if>
						<tr>
							<td class="td_center" rowspan="2" width="20%"><b>Кадастровый номер здания, сооружения, объекта незавершенного строительства</b></td>
							<td class="td_center" rowspan="2" width="10%"><b>Номера точек контура</b></td>
							<td class="td_center" colspan="2" width="20%"><b>Координаты</b></td>
							<td class="td_center" rowspan="2" width="15%"><b>Радиус (R)</b></td>
							<td class="td_center" rowspan="2" width="30%"><b>Особые отметки (точность определения)</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>X</b></td>
		...
		<xsl:if test="($current_number + ($max_page_records*4)) &lt; $spatialObjects_records">
			<!--Рекурсивный вызов шаблона-->
			<xsl:call-template name="Page3_2">
				<xsl:with-param name="current_number" select="($current_number + ($max_page_records*4))"/>
				<xsl:with-param name="current_page" select="$current_page+1"/>
			</xsl:call-template>
		</xsl:if>
	...
	<xsl:template name="Page4_1">
				...
				<td>
					...
					<table class="tbl_section_content" style="width: 100%; border-bottom: 0">
						<tr>
							...
							<xsl:if test="not($current_number &lt; $max_page_records+1)">
								<td style="width: 75%; border-bottom: 0">
									<b>
										<nobr>Номер кадастрового квартала: </nobr>
										<nobr>
						...
						<table class="tbl_section_title">
							<tr>
								<td>
									<br/>
									<b>
										<nobr>Сведения об объектах землеустройства, единицах кадастрового деления:</nobr>
										<br/>
										<nobr>&nbsp;&nbsp;&nbsp;&nbsp;I. Общая информация об объектах землеустройства, единицах кадастрового деления</nobr>
									</b>
									<br/>
								</td>
							</tr>
					...
					<table class="tbl_section_content">
						<tr>
							<td class="td_center" width="10%"><b>Номер п/п</b></td>
							<td class="td_center" width="30%"><b>Вид и наименование (индивидуальное обозначение) объекта землеустройства, единицы кадастрового деления</b></td>
							<td class="td_center" width="20%"><b>Реквизиты решений об установлении или изменении границ объектов землеустройства, единиц кадастрового деления</b></td>
							<td class="td_center" width="40%"><b>Сфера ограничений</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>1</b></td>
							<td class="td_center"><b>2</b></td>
		...
		<xsl:if test="($current_number + ($max_page_records+1)) &lt; $decision_records">
			<!--Рекурсивный вызов шаблона-->
			<xsl:call-template name="Page4_1">
				<xsl:with-param name="current_number" select="($current_number + ($max_page_records+1))"/>
				<xsl:with-param name="current_page" select="$current_page+1"/>
			</xsl:call-template>
		</xsl:if>
	...
	<xsl:template name="Page4_2">
		...
		<table class="tbl_page">
			<tr>
				<td>
					...
					<table class="tbl_section_content" style="width: 100%; border-bottom: 0">
						<tr>
							<xsl:if test="$current_number &lt; $max_page_records*2">
								<td style="width: 75%">
									<b>
										<nobr>Номер кадастрового квартала: </nobr>
										<nobr>
							...
							<xsl:if test="not($current_number &lt; $max_page_records*2)">
								<td style="width: 75%; border-bottom: 0">
									<b>
										<nobr>Номер кадастрового квартала: </nobr>
										<nobr>
						...
						<table class="tbl_section_title">
							<tr>
								<td>
									<br/>
									<b>
										<nobr>&nbsp;&nbsp;&nbsp;&nbsp;II. Описание местоположения границ объектов землеустройства, единиц кадастрового деления</nobr>
									</b>
									<br/>
								</td>
							</tr>
					...
					<table class="tbl_section_content">
						<tr>
							<td class="td_center" rowspan="2" width="15%"><b>Номер п/п</b></td>
							<td class="td_center" rowspan="2" width="30%"><b>Вид и наименование (индивидуальное обозначение) объекта землеустройства, единицы кадастрового деления</b></td>
							<td class="td_center" rowspan="2" width="10%"><b>Номера точек</b></td>
							<td class="td_center" colspan="2" width="20%"><b>Координаты</b></td>
							<td class="td_center" rowspan="2" width="20%"><b>Метод определения координат</b></td>
							<td class="td_center" rowspan="2" width="35%"><b>Особые отметки (точность определения)</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>X</b></td>
							<td class="td_center"><b>Y</b></td>
		...
		<xsl:if test="($current_number + ($max_page_records*2)) &lt; $spatial_records">
			<!--Рекурсивный вызов шаблона-->
			<xsl:call-template name="Page4_2">
				...
				<td>
					...
					<table class="tbl_section_content">
						<xsl:if test="$current_number &lt; $max_page_records*2">
							<tr>
								<td colspan="5">
									<b><nobr>Сведения о пунктах опорной межевой сети</nobr></b>
								</td>
							</tr>
						</xsl:if>
						<tr>
							<td class="td_center" rowspan="2" width="20%"><b>Номер пункта опорной межевой сети на плане</b></td>
							<td class="td_center" rowspan="2" width="30%"><b>Название и (или) номер, тип пункта опорной межевой сети</b></td>
							<td class="td_center" rowspan="2" width="20%"><b>Класс опорной межевой сети</b></td>
							<td class="td_center" colspan="2" width="30%"><b>Координаты</b></td>
						</tr>
						<tr>
							<td class="td_center"><b>X</b></td>
							<td class="td_center"><b>Y</b></td>
	...
	<xsl:template match="kpt:EntitySpatial" mode="kpt21">
		...
		<xsl:text>Coords1[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>] = new Array();</xsl:text>
		<xsl:text>Coords1[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0] = new Array();</xsl:text>
		<xsl:text>Coords1[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0][0] = "</xsl:text>
	...
	<xsl:template match="kpt:EntitySpatial" mode="kpt22">
		...
		<xsl:text>Coords2[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>] = new Array();</xsl:text>
		<xsl:text>Coords2[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0] = new Array();</xsl:text>
		<xsl:text>Coords2[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0][0] = "</xsl:text>
	...
	<xsl:template match="kpt:EntitySpatial" mode="kpt23">
		...
		<xsl:text>Coords3[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>] = new Array();</xsl:text>
		<xsl:text>Coords3[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0] = new Array();</xsl:text>
		<xsl:text>Coords3[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0][0] = "</xsl:text>
	...
	<xsl:template match="kpt:EntitySpatial" mode="kpt24">
		...
		<xsl:text>Coords4[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>] = new Array();</xsl:text>
		<xsl:text>Coords4[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0] = new Array();</xsl:text>
		<xsl:text>Coords4[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][0][0] = "</xsl:text>
		<xsl:if test="parent::kpt:Zone">
			<xsl:text>Z</xsl:text>
			<xsl:value-of select="ancestor::kpt:Zone/kpt:AccountNumber"/>
		</xsl:if>
	...
	<xsl:template match="spa:SpatialElement">
		...
		<xsl:if test="$itemElement > 0">
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>] = new Array();</xsl:text>
		</xsl:if>
	...
	<xsl:template match="spa:SpelementUnit" mode="kpt2">
		...
		<xsl:if test="not(spa:R)">
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>][</xsl:text><xsl:value-of select="($itemUnit * 2) - 1"/><xsl:text>] = </xsl:text><xsl:value-of select="spa:Ordinate/@X"/><xsl:text>;</xsl:text>
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>][</xsl:text><xsl:value-of select="($itemUnit * 2)"/><xsl:text>] = </xsl:text><xsl:value-of select="spa:Ordinate/@Y"/><xsl:text>;</xsl:text>
		</xsl:if>
		<xsl:if test="spa:R">
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>][</xsl:text><xsl:value-of select="($itemUnit * 3) - 2"/><xsl:text>] = </xsl:text><xsl:value-of select="spa:Ordinate/@X"/><xsl:text>;</xsl:text>
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>][</xsl:text><xsl:value-of select="($itemUnit * 3) - 1"/><xsl:text>] = </xsl:text><xsl:value-of select="spa:Ordinate/@Y"/><xsl:text>;</xsl:text>
			<xsl:text>Coords</xsl:text><xsl:value-of select="$numArray"/><xsl:text>[</xsl:text><xsl:value-of select="$itemEntity"/><xsl:text>][</xsl:text><xsl:value-of select="$itemElement"/><xsl:text>][</xsl:text><xsl:value-of select="($itemUnit * 3)"/><xsl:text>] = </xsl:text><xsl:value-of select="spa:R"/><xsl:text>;</xsl:text>
		</xsl:if>
	</xsl:template>
	<!--Корневой элемент-->
	<xsl:template match="kpt:KPT">
		...
		<xsl:if test="$objects">
			<xsl:call-template name="Page1_2">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="descendant::kpt:SpatialData/kpt:EntitySpatial|descendant::kpt:Parcel/descendant::kpt:EntitySpatial|descendant::kpt:ObjectsRealty/descendant::kpt:EntitySpatial">
			<xsl:call-template name="Page2_1">
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="descendant::kpt:Bound/descendant::kpt:EntitySpatial">
			<xsl:call-template name="Page2_2">
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="descendant::kpt:Zone[kpt:SpecialZone]/descendant::kpt:EntitySpatial">
			<xsl:call-template name="Page2_3">
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="descendant::kpt:Zone[kpt:TerritorialZone]/descendant::kpt:EntitySpatial">
			<xsl:call-template name="Page2_4">
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="$spatialsParcel">
			<xsl:call-template name="Page3_1">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+ $kpt24listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="$spatialsObjects">
			<xsl:call-template name="Page3_2">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+$kpt24listcount+$kpt31listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="$spatials|$decisions">
			<xsl:call-template name="Page4_1">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+$kpt24listcount+$kpt31listcount+$kpt32listcount+1"/>
			</xsl:call-template>
			<xsl:call-template name="Page4_2">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+$kpt24listcount+$kpt31listcount+$kpt32listcount+$kpt41listcount+1"/>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="$oms">
			<xsl:call-template name="Page5">
				<xsl:with-param name="current_number" select="0"/>
				<xsl:with-param name="current_page" select="$kpt11listcount+$kpt12listcount+$kpt21listcount+$kpt22listcount+$kpt23listcount+$kpt24listcount+$kpt31listcount+$kpt32listcount+$kpt41listcount+$kpt42listcount+1"/>
			</xsl:call-template>
		</xsl:if>
	</xsl:template>
</xsl:stylesheet>
